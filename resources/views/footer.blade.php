<div class="grid grid-cols-3 h-50 text-left">
    ...
    <h2 class="font-serif tracking-wide text-rosa text-lg mb-4">Categorías</h2>
        <ul class="font-sans text-rosa text-sm">
            <li><a href="{{ route('home') }}">Desarrollador Full-Stack</a></li>
            <li><a href="{{ route('home') }}">Desarrollador UX/UI</a></li>
            <li><a href="{{ route('home') }}">Desarrollador Front-End</a></li>
            <li><a href="{{ route('home') }}">Desarrollador BackEnd</a></li>
        </ul>
        </a>
    </div>
</div>
